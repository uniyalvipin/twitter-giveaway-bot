...
search_tags = ["bitcoin giveaway","ethereum giveaway","cgso skins","csgo","btc","eth","giveaway"]
...
message_text = ["I want to enter to the giveaway!", "Hope to win :D", "Hi there! Love from India :-)"]

#replying to a tweet or tag friends
reply_tags=["reply", "tag", "comment", "mention"]
...
banned_users = []
#skip fake, external and unwanted giveaways
fake=["@rambo_tuga", "@csgoskinslucky", "@ensigskins", "@rihardinjss", "@csgodarknet", "@go_giveaway", "@csgogamblecode1", "bts", "music", "album", "albums", "with the link", "gleam", "come and join the", "@SzymekJa"]
